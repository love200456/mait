...
<body style=" height: 100%;">
	<c:if test="${judge == '1' }">
		<form action="${basePath }AdvertisingCategory/insertAC.action?levels=1" method="post" enctype="multipart/form-data">
			<div class="content">
				<div class="advclass">
	...
	<c:if test="${judge == '2' }">
		<div class="content">
			<form action="${basePath }AdvertisingCategory/updateAC.action?levels=1" method="post" enctype="multipart/form-data">
